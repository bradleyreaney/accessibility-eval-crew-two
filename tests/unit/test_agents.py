...
class TestAgentTools:
    ...
    def test_gap_analyzer_tool_coverage_calculation(self):
        ...
        """
        audit_content = "Found issues with keyboard, contrast, alt text, headings, focus"
...
class TestGapAnalyzerTool:
    ...
    def test_extract_audit_issues(self):
        ...
        assert "violation" in issue_text or "error" in issue_text or "missing" in issue_text
    ...
    def test_analyze_audit_coverage(self):
        ...
        coverage = self.tool._analyze_audit_coverage(self.sample_plan, self.sample_audit)
    ...
    def test_analyze_audit_coverage_no_matches(self):
        ...
        unrelated_plan = "This plan talks about database optimization and server performance."
    ...
    def test_analyze_audit_coverage_perfect_match(self):
        ...
        """
        coverage = self.tool._analyze_audit_coverage(comprehensive_plan, self.sample_audit)
    ...
    def test_identify_wcag_gaps(self):
        ...
        has_color_gap = any(keyword in " ".join(gap_keywords) for keyword in color_keywords)
    ...
    def test_generate_gap_report(self):
        ...
        report = self.tool._generate_gap_report("TestPlan", coverage, wcag_gaps, audit_issues)
    ...
    def test_identify_strategic_gaps(self):
        ...
        assert len(gaps) > 0
        gaps_text = " ".join(gaps)
        assert "critical" in gaps_text or "partial" in gaps_text or "unaddressed" in gaps_text
